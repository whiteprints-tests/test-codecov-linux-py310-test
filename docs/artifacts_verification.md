...
```console
gh attestation verify <path_to_the_release_artifact> --repo whiteprints-tests/test-codecov-linux-py310-test
```
...
cosign verify-blob \
    ...
    --certificate-identity-regexp="^https://github.com/whiteprints-tests/test-codecov-linux-py310-test/.github/workflows/upload_artifacts.yml?" \
