...
The project is hosted on [https://github.com/whiteprints-tests/test-codecov-linux-py310-test.git](https://github.com/whiteprints-tests/test-codecov-linux-py310-test.git).
