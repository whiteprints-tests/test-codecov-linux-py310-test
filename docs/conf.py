...
project = "test codecov linux py310-test"
...
release = metadata.version("test_codecov_linux_py310_test")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-codecov-linux-py310-test",
